import { monthIndexToString } from '../../utils/utils'
...
export default [
  {
    title: `${monthIndexToString(month)} Event One`,
  ...
  {
    title: `${monthIndexToString(month)} Event Two`,
    description: "blah blah blah",
  ...
  {
    title: `${monthIndexToString(month)} Event Three`,
    description: "blah blah blah",
  ...
  {
    title: `${monthIndexToString(month + 1)} Event One`,
    description: "blah blah blah",
  ...
  {
    title: `${monthIndexToString(month + 1)} Event Two`,
    description: "blah blah blah",
  ...
  {
    title: `${monthIndexToString(month + 1)} Event Three`,
    description: "blah blah blah",
